 ...
 *
 * <p><b>Layer 1 — JWT validation (direct-access protection):</b><br>
 ...
 * An <em>invalid</em> token short-circuits here — it does <em>not</em> fall
 ...
 *
 * <p><b>Layer 2 — Trusted gateway headers (normal gateway path):</b><br>
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (jwt != null) {
            // --- Layer 1: JWT present — validate it ---
            ...
            if (jwtService.isTokenValid(jwt)
                ...
                try {
                    ...
                    // Parsing failed after isTokenValid — leave context empty
                }
            }
        } else {
            // --- Layer 2: No JWT — trust gateway-injected headers ---
            ...
            if (userIdHeader != null && !userIdHeader.isBlank()
                ...
                try {
                    ...
                    // Malformed header — stay anonymous
                }
            }
        }
